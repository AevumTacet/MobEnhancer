...
public class Latcher implements ZombieCustomType {
    ...
    public void onAttack(Zombie zombie, EntityDamageByEntityEvent e) {
        ...
        if (!l.getPassengers().contains(zombie))
            zombie.getWorld().playSound(zombie.getLocation(), Sound.ITEM_ARMOR_EQUIP_GENERIC, 1, 1);
    }
}
